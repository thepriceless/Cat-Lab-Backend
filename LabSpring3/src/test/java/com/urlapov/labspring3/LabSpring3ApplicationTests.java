...
class LabSpring3ApplicationTests {
    ...
    public void ownCatAndGetCat_ExpectCat() throws Exception {
        mvc.perform(post("/cats/own").content(asJsonString(new CatOwnerLink(1L, 1L)))
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
        ...
        mvc.perform(get("/cats/1")
            ...
            .andExpect(content().json(asJsonString(
                new CatDto(1L, "Zyw0o", LocalDate.of(2003, 8, 1), "Shiz", ServiceCatColor.Grey, 1L, new ArrayList<Long>()))));
    }
    ...
    public void makeFriends_ExpectFriends() throws Exception {
        ...
        mvc.perform(get("/cats/1")
            ...
            .andExpect(status().isOk())
            .andExpect(content().json(asJsonString(
                new CatDto(1L, "Zyw0o", LocalDate.of(2003, 8, 1), "Shiz", ServiceCatColor.Grey, 1L, new ArrayList<Long>(Arrays.asList(3L))))));
