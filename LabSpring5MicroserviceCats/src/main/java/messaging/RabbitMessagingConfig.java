...
public class RabbitMessagingConfig {
    ...
    public static String outcomeToOwnerServiceQueueName;
    ...
    public static String outcomeToOwnerServiceRoutingName;
    ...
    @Bean
    public Queue outcomeToOwnerServiceQueue() {
        return new Queue(outcomeToOwnerServiceQueueName, true);
    }
    ...
    @Bean
    Binding bindingOutcomeToOwnerService(Queue outcomeToOwnerServiceQueue, DirectExchange exchange){
        return BindingBuilder.bind(outcomeToOwnerServiceQueue).to(exchange).with(outcomeToOwnerServiceRoutingName);
    }
    ...
    @Value("${queue.name.with-owners}")
    private void setOutcomeToOwnerServiceQueueNameStatic(String name){
        RabbitMessagingConfig.outcomeToOwnerServiceQueueName = name;
    }
    ...
    @Value("${spring.rabbitmq.template.routing-key.owners}")
    private void setOutcomeToOwnerServiceRoutingNameStatic(String name){
        RabbitMessagingConfig.outcomeToOwnerServiceRoutingName = name;
    }
}
